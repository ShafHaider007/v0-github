...
export default function MarketingRouteGuard({ children }) {
  ...
  useEffect(() => {
    ...
    if (!isLoading) {
      if (!isAuthenticated) {
        ...
        // Not a marketing user, redirect to appropriate dashboard
        if (role > 0) {
          router.push("/admin")
        } else {
        ...
        // User is authenticated, doesn't have a temporary password, and is a marketing user
        setCanAccess(true)
      }
    }
